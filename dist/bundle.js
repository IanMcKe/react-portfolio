	  ...
	  _createClass(Nav, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _reactRouter.Link,
	          { className: 'nav-link', to: '/work' },
	          'Work'
	        ),
	        _react2.default.createElement(
	          'a',
	          { className: 'nav-link', href: 'mailto:ian.j.mcke@gmail.com' },
	          'Email Me'
	        ),
	        _react2.default.createElement(
	          'a',
	          { className: 'nav-link', href: 'https://github.com/IanMcKe' },
	          'Github'
	        ),
	        _react2.default.createElement(
	          'a',
	          { className: 'nav-link', href: 'https://www.linkedin.com/in/ianmckenney' },
	          'Linked In'
	        )
	      );
	    }
